...
public class ShopUIManager : MonoBehaviour
{
    ...
    [SerializeField] private GameObject toiletPanel;
    ...
    [SerializeField] private Transform toiletContent;
    
    [Header("Tab Buttons")]
    [SerializeField] private Button charactersTabButton;
    [SerializeField] private Button toiletsTabButton;
    ...
    private void Initialize()
    {
        ...
        toiletsTabButton?.onClick.AddListener(() => SwitchTab(ShopItemType.Toilet));
    ...
    private void SwitchTab(ShopItemType tabType)
    {
        ...
        toiletPanel?.SetActive(tabType == ShopItemType.Toilet);
    ...
    private void UpdateTabButtons()
    {
        ...
        if (toiletsTabButton != null)
        {
            Image img = toiletsTabButton.GetComponent<Image>();
            if (img != null)
            {
                img.color = _currentTab == ShopItemType.Toilet ? selectedTabColor : normalTabColor;
            }
        }
    }
    ...
    private void PopulateShopItems(ShopItemType type)
    {
        ...
        Transform container = type == ShopItemType.Character ? characterContent : toiletContent;
